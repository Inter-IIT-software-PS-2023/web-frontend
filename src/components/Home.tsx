...
export default function VerticalLinearStepper() {
	...
	// const [genrateValidate, setGenValidate] = React.useState(false)
	// const [custerValidate, setClustValidate] = React.useState(false)
	const handleNext = () => {
		// if (activeStep === 1 && !feedValidateRider && !feedValidateUpload) {
